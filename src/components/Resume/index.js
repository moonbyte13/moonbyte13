...
function Resume() {
  ...
  return (
    <div id='resumeSect' className="row-start-3 lg:row-start-4 row-span-2 flex flex-col items-center">
      ...
      <div className="row-start-5 row-end-12 col-span-12 text-center text-[1em] text-[#a4d4b4] flex w-full">
        <br/>
        <div className={`w-full grid gap-2 p-5 ${isLargeScreen ? 'grid-cols-10 grid-rows-8' : isMediumScreen ? 'grid-cols-8 grid-rows-auto' : isSmallScreen ? 'grid-cols-6 grid-rows-auto' : 'grid-cols-4 grid-rows-auto'}`}>
