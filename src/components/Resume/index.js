...
function Resume() {
  ...
  return (
    <div className="grid grid-cols-12 grid-rows-12">
      <h2 className="text-[2vw] text-[#b39ddb] font-semibold col-start-6">Resume</h2>
      <div id='resumeIcon' className='row-start-2 row-span-2 col-start-6'>
      ...
      <label 
        className='row-start-4 col-start-6 col-span-2 text-[1vw] text-[#b39ddb] animate-bounce'
      >^ Click Above to Download! ^</label>
      <div className="row-start-5 row-end-12 col-span-12 text-center text-[1vw] text-[#a4d4b4] text-center">
        <br/>
        <div>
